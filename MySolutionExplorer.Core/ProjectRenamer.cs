...
namespace MySolutionExplorer.Core
{
        ...
        where T : Project, new()
    {
        ...
        public int Number
        {
            get => NewProject.Number;
            set => NewProject.Number = value;
        }

        public string Site
        {
            get => NewProject.Site;
            set => NewProject.Site = value;
        }

        public string TaskName
        {
            get => NewProject.TaskName;
            set => NewProject.TaskName = value;
        }
        ...
        public void Rename()
        {
            if (OldProject.ParentSolution.Dir.GetDirectories().Any(u => u.Name == NewProject.Name))
            {
                return;
            }
        ...
        public void Dispose() => OldProject.Delete();
    }
}
